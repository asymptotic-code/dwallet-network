...
// fun staked_ika_specs::is_withdrawing_spec [verification] at ./sources/staked_ika_specs.move:26:1+91
procedure {:timeLimit 3000} $0_staked_ika_is_withdrawing$verify(_$t0: $0_staked_ika_StakedIka) returns ($ret0: bool)
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/staked_ika_specs.move:26:1+1
    ...
    call $t1 := $0_staked_ika_is_withdrawing$impl($t0);
    if ($abort_flag) {
        assume {:print "$at(255,796,826)"} true;
        $t2 := $abort_code;
...
// fun staked_ika_specs::is_withdrawing_spec [baseline] at ./sources/staked_ika_specs.move:26:1+91
procedure {:inline 1} $0_staked_ika_is_withdrawing$asserts(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
...
// fun staked_ika_specs::is_withdrawing_spec [verification] at ./sources/staked_ika_specs.move:26:1+91
procedure {:timeLimit 3000} $0_staked_ika_is_withdrawing$spec_no_abort_check$verify(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    // $t1 := staked_ika::is_withdrawing($t0) at ./sources/staked_ika_specs.move:27:5+30
    assume {:print "$at(255,796,826)"} true;
    $t1 := $0_staked_ika_is_withdrawing$opaque($t0);

    // $t1 := havoc[val]() at ./sources/staked_ika_specs.move:26:1+91
    assume {:print "$at(255,737,828)"} true;
    havoc $t1;
