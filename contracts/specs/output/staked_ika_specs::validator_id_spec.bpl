...
// fun staked_ika_specs::validator_id_spec [verification] at ./sources/staked_ika_specs.move:6:1+85
procedure {:timeLimit 3000} $0_staked_ika_validator_id$verify(_$t0: $0_staked_ika_StakedIka) returns ($ret0: $2_object_ID)
{
    // declare local variables
    var $t1: $2_object_ID;
    var $t2: int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/staked_ika_specs.move:6:1+1
    ...
    call $t1 := $0_staked_ika_validator_id$impl($t0);
    if ($abort_flag) {
        assume {:print "$at(255,200,228)"} true;
        $t2 := $abort_code;
...
// fun staked_ika_specs::validator_id_spec [baseline] at ./sources/staked_ika_specs.move:6:1+85
procedure {:inline 1} $0_staked_ika_validator_id$asserts(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: $2_object_ID;
    var $t2: int;
...
// fun staked_ika_specs::validator_id_spec [verification] at ./sources/staked_ika_specs.move:6:1+85
procedure {:timeLimit 3000} $0_staked_ika_validator_id$spec_no_abort_check$verify(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: $2_object_ID;
    var $t2: int;
    ...
    // $t1 := staked_ika::validator_id($t0) at ./sources/staked_ika_specs.move:7:5+28
    assume {:print "$at(255,200,228)"} true;
    $t1 := $0_staked_ika_validator_id$opaque($t0);

    // $t1 := havoc[val]() at ./sources/staked_ika_specs.move:6:1+85
    assume {:print "$at(255,145,230)"} true;
    havoc $t1;
