...
// fun staked_ika_specs::is_staked_spec [verification] at ./sources/staked_ika_specs.move:21:1+81
procedure {:timeLimit 3000} $0_staked_ika_is_staked$verify(_$t0: $0_staked_ika_StakedIka) returns ($ret0: bool)
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/staked_ika_specs.move:21:1+1
    ...
    call $t1 := $0_staked_ika_is_staked$impl($t0);
    if ($abort_flag) {
        assume {:print "$at(255,642,667)"} true;
        $t2 := $abort_code;
...
// fun staked_ika_specs::is_staked_spec [baseline] at ./sources/staked_ika_specs.move:21:1+81
procedure {:inline 1} $0_staked_ika_is_staked$asserts(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
...
// fun staked_ika_specs::is_staked_spec [verification] at ./sources/staked_ika_specs.move:21:1+81
procedure {:timeLimit 3000} $0_staked_ika_is_staked$spec_no_abort_check$verify(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: bool;
    var $t2: int;
    ...
    // $t1 := staked_ika::is_staked($t0) at ./sources/staked_ika_specs.move:22:5+25
    assume {:print "$at(255,642,667)"} true;
    $t1 := $0_staked_ika_is_staked$opaque($t0);

    // $t1 := havoc[val]() at ./sources/staked_ika_specs.move:21:1+81
    assume {:print "$at(255,588,669)"} true;
    havoc $t1;
