...
// fun staked_ika_specs::withdraw_epoch_spec [verification] at ./sources/staked_ika_specs.move:31:1+90
procedure {:timeLimit 3000} $0_staked_ika_withdraw_epoch$verify(_$t0: $0_staked_ika_StakedIka) returns ($ret0: int)
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/staked_ika_specs.move:31:1+1
    ...
    call $t1 := $0_staked_ika_withdraw_epoch$impl($t0);
    if ($abort_flag) {
        assume {:print "$at(255,954,984)"} true;
        $t2 := $abort_code;
...
// fun staked_ika_specs::withdraw_epoch_spec [baseline] at ./sources/staked_ika_specs.move:31:1+90
procedure {:inline 1} $0_staked_ika_withdraw_epoch$asserts(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
...
// fun staked_ika_specs::withdraw_epoch_spec [verification] at ./sources/staked_ika_specs.move:31:1+90
procedure {:timeLimit 3000} $0_staked_ika_withdraw_epoch$spec_no_abort_check$verify(_$t0: $0_staked_ika_StakedIka) returns ()
{
    // declare local variables
    var $t1: int;
    var $t2: int;
    ...
    // $t1 := staked_ika::withdraw_epoch($t0) at ./sources/staked_ika_specs.move:32:5+30
    assume {:print "$at(255,954,984)"} true;
    $t1 := $0_staked_ika_withdraw_epoch$opaque($t0);

    // $t1 := havoc[val]() at ./sources/staked_ika_specs.move:31:1+90
    assume {:print "$at(255,896,986)"} true;
    havoc $t1;
